"""
Stability Validation Script for XGBoost Model v2.7 - Cross-Pair Features (REFACTORED).
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Stability validation for XGBoost model v2.7')
    parser.add_argument('--skip-hpo', action='store_true',
                        help='Skip Phase 1 (HPO) and use existing hyperparameters')
    parser.add_argument('--version', type=str, default='v2_7', choices=['v2_6', 'v2_7'],
                        help='Model version to validate (default: v2_7)')
